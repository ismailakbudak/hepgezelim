    ...
    <style type="text/css">
      .list-group-item{ width: 100%; float: left;   margin: 3.5px; }
		                                                     ...
		                                                     <section class='user-container clearfix'>
		                                                            <div class='profile-user'>
		                                                                <div class='profile-user-container'>
		                                                                        <strong> <?=  lang("a.email") ?> </strong>     </strong>
		                                                                        <?=  $value['email'] ?> 
		                                                                        <strong> <?=  lang("a.problem") ?> </strong>
		                                                                        <?=  $value['problem'] ?> 
            ...
            <script type="text/javascript">
                ...
                $( function(){
                     ...
                     $(".process-readed").on('click',function(){
                             var id = $( this ).data("id");
                             var data = {id:id }; 
                             var url = "problem_readed_process"; 
