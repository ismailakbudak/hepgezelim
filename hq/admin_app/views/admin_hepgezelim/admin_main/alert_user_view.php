		            ...
		            <div class="row slide" > 
		                    <div class="col-lg-12" >
		                        <div class="bs-example">
		                            <legend class="text-danger" > <?= lang("a.alert-user-messages") ?> </legend> 
		                            <ul class="list-group">
		                                        <?  foreach ($alerts as $value) {      ?>
		                                        <?  $crypted_received_id     =  my_encode($value['received_user_id']);                    ?>
		                                        <?  $crypted_sender_id       =  my_encode($value['sender_user_id']);                      ?>
		                                        <?  $crypted_alert_user_id   =  my_encode($value['id']);                                  ?>
												    ...
												    $foto2 = $value['r_foto'];
		                                                ...
		                                                <li class='list-group-item' data-id='<?= $value['id'] ?>' >
		                                                     <section class='user-container clearfix'>
		                                                            ...
		                                                            <div class='row data-process' data-id='<?= $crypted_alert_user_id ?>' >
		                                                               
		                                                                <a class="process-readed"  href='#' title='<?= lang("readed") ?>'  data-id='<?= $crypted_alert_user_id ?>'  style='margin-right:10px;' >
                                                                        ...
                                                                        <? } if( $value['received_user_id'] > 0 ){     ?>  
                                                                                    <strong class="small"> <?= lang("a.receiver-process") ?> </strong>
            		                                                                <a class="warn-modal-open"  href='#warn-user-modal' data-toggle='modal' title='<?= lang("receiver-warn") ?>' data-id='<?= $crypted_received_id ?>' style='margin-right:10px;' >
            		                                                                  <span class='text-danger glyphicon glyphicon-user'></span>
            		                                                                </a>
            		                                                                 <a class="user-ban"  href='#' title='<?= lang("receiver-ban") ?>' data-id='<?= $crypted_received_id ?>'  style='margin-right:10px;' >
            ...
            <script type="text/javascript">
                ...
                $( function(){
                     ...
                     $(".process-readed").on('click',function(){
                             ...
                             var data = {id:id }; 
                             var url = "alert_user_readed_process"; 
