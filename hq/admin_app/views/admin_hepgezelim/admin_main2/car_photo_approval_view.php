    ...
    <div class="container">
            <div class="row well" style="padding: 30px 20px 30px 20px; margin:5px 0px 0px 0px; background-color: #FFFFFF; margin-top:20px" >
               <?= lang("a.approval-car-photo-more") ?>  <a href="<?= new_url('admin_hepgezelim/car_photo_approval_view/' . $OFFSET ) ?>"> <?= lang("click") ?> </a>
            </div>
    	    <? if( $OFFSET > $LIMIT ){ ?>
    	            <div class="row well" style="padding: 30px 20px 30px 20px; margin:5px 0px 0px 0px; background-color: #FFFFFF; margin-top:20px" >
                       <?= lang("a.first-page") ?>  <a href="<?= new_url('admin_hepgezelim/car_photo_approval_view/0' ) ?>"> <?= lang("click") ?> </a>
                    </div>
    	    <? } ?> 
    	    <div class="row well" style="padding: 30px 20px 30px 20px; margin:5px 0px 0px 0px; background-color: #FFFFFF; margin-top:20px" >
		            <div class="row slide" > 
		                    <div class="col-lg-12" >
		                        <div class="bs-example">
		                            <legend class="text-success"  > <?= lang("a.car-images2") ?> </legend> 
		                            <ul class="list-group">
