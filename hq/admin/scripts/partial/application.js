...
//////////////////////////////////////////////////
          ...
          // jQuery Begin
            ...
            function AjaxSendJson2(url,data){var jqXHR=$.ajax({type:"POST",url:base_url2+url,dataType:"json",async:false,cache:false,data:data,success:function(answer){},error:function(){}});if(strcmp(enviroment,"development")==0)alert(jqXHR.responseText);return jqXHR.responseText}
            $(function(){
