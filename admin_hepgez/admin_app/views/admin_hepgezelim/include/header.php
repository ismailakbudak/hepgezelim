...
<html lang="<?= $this->lang->lang() ?>">
  ...
  <body>  
                         ...
                         <div class="navbar-collapse collapse navbar-responsive-collapse" id="navbar-main">
                           <ul class="nav navbar-nav">
                                ...
                                <li ><a href="<?php echo new_url('admin_hepgezelim/contact_view')  ?>"   >
                                  ...
                                  <li ><a href="<?php echo new_url('searches')  ?>"   >
                                       <?=lang('a.search')?> 
                                       <i class="  glyphicon glyphicon-search two"> </i>
                                       <span class="badge btn-warning mybadge4"  style="left: 88px;" ><?php echo $search_count ?></span></a>
                                </li>
    ...
    <script type="text/javascript">
        ...
        var base_url2 = '<?php echo new_url(); ?>';
