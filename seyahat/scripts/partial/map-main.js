...
//////////////////////////////////////////////////
 ...
 var place1 = {x:-1, y:-1, status:0 },
     place2 = {x:-1, y:-1, status:0 };
...
(function($){
        ...
        $('#search').on("click",function(){
              var origin =  $( "#pac-input" ).val().trim().replace(" ", "+"),
                  destination    = $( "#pac-input2" ).val().trim().replace(" ", "+"),
...
$( ".mostSearched" ).on('click',function(){
    $( ".searchedResult" ).slideToggle();
    return false;
})
$( ".mostCreated" ).on('click',function(){
    $( ".createdResult" ).slideToggle();
    return false;
})