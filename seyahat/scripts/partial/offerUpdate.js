 ...
 (function($){ 
                   ...
                   if( $( "#radiosOnetime" ).is(":checked") === true ){       
                            ...
                            if ( boolValid ) {
                                      var dataForm = {    round_trip: isTwoway, 
                                                  ...
                                                  url = 'offer/createOffer1Update',
                                                  result = JSON.parse( AjaxSendJson(url,dataForm) );  
                                                  if( strcmp(result.status      ,'success') == 0 ) {  window.location = base_url + 'offer/update2' }
       ...
       /*======================================================================================================***/
          ...
          var array = $( "#iteneraryPanel" ).find(".wayPoints"),
              sayi = array.length-1;
          for (var i = 0; i < array.length; i++) {
               var id = 'wayPoint'+i;
               deneme(id);
          ...
          function cikar(){
                ...
                $( '.minus' ).on('click',function(){
                     ...
                     var dizi = $("#iteneraryPanel").find(".wayPoints");
                    // $('body').modalmanager('loading');
                     mapDraw();
                });
           }
