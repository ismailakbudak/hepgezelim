...
class CI_Email {
	...
	var	$smtp_host		= "smtp.yandex.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "hep@hepgezelim.com";		// SMTP Username
	var	$smtp_pass		= "10253001.:";		// SMTP Password
