  ...
  function wayPoints($offer){
         ...
         if( count($offer['way_points']) > 0 ){
             for ($i=0; $i < count($offer['way_points']) ; $i++ ) {
                    ...
                    $str  = explode(  ",", $str0 );
                    if( $i == 0)
                        $val .= "<strong class='text-primary' style='font-size:20px;' title='$str0' >" . $str[0] ."</strong>→" ;
                     else{
               ...
               $val .= "<strong class='text-primary' style='font-size:20px;' title='$str0' >" . $str2[0] ."</strong>" ;
         }else{
         ...
         if( count($ways ) > 0 ){
               for ($i=0; $i < count($ways ) ; $i++ ) { 
                    ...
                    if(  strcmp($str , $origin ) == 0 )
                       $val .= "<strong title='$str' class='text-primary' style='font-size:20px;' >" . $str2 ."</strong>→" ;
  ...
  function wayPointsReverse($offer){
         ...
         if( count($offer['way_points']) > 0 ){
               for ($i= count($offer['way_points']) - 1;  $i >= 0; $i-- ) { 
                    $str = explode(  ",", $offer['way_points'][$i]['arrivial_place'] );
               ...
               $str2 = explode(  ",", ($offer['way_points'][0]['departure_place']) ); //$offer['destination'] );
