...
<html lang="<?= lang('lang') ?>">
  ...
  <body>
    ...
    <div style="height:20px;"></div> 
        <!-- Modal login
    =====================================================-->
    <div id="login" class="modal fade" tabindex="-1" data-width="440" data-height="360" style="display: none;">
    ...
    <div id="joinus" class="modal fade" tabindex="-1" data-width="430" data-height="360" style="display: none;">
     ...
     <!-- Modal newuser
    =====================================================-->
    <div id="newuser" class="modal fade" tabindex="-1" data-width="450" data-height="570" style="display: none;">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
