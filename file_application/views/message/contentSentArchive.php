                         ...
                         if( count($conversation) == 0 ){
                              echo " <div class='bs-example'>
                                         <div class='alert alert-dismissable alert-info'>
                                              ...
                                              <h4> ". lang("m.empty") ." <a href='". new_url('message/sentArchive/' . $message['offer_id'] ."/". $message['sender_id'] ) ."' style='margin:10px' title='". lang('refresh') ."' >
      ...
      <script src="<?php echo   base_url() . 'scripts/partial/messages/contentSentArchieve.js' ?>"></script>
