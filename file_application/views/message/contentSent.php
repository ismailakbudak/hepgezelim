                               ...
                               <div class='well' style="padding: 0px">
                                  <form class='bs-example form-horizontal'>
                                      <fieldset>
                                            ...
                                            <div id="data" class='col-lg-4 msg' data-name='<?= $receiver['name'] ." ".$receiver['surname']  ?>'  
                                                  data-offer_id='<?= $this->encrypt->encode($offer['id']) ?>' 
                                                  data-received_userid='<?= $this->encrypt->encode($receiver['id']) ?>' > 
                                                ...
                                                <a href='#block-user-modal-send'  data-toggle='modal' class='block-user-send'  >
                                                  ...
                                                  <div class='row'>
                                                        <div  class='msg-comment-receiver'>
                                                            ...
                                                            <div class='row text-right dateMSG' style='margin-top:10px'> 
                                                                ...
                                                                <a href='#'  class='alert-moderator-send' data-message_id='". $this->encrypt->encode($message['id'])   . "' > 
                         ...
                         if( count($conversation) == 0 ){
                              echo " <div class='bs-example'>
                                         <div class='alert alert-dismissable alert-info'>
                                              ...
                                              <h4> ". lang("m.empty") ." <a href='". new_url('message/sent/' . $message['offer_id'] ."/". $message['sender_id'] ) ."' style='margin:10px' title='". lang('refresh') ."' >
                             ...
                             echo  "<li class='list-group-item  '>
                                         <div class='row'>
                                              ...
                                              <div  class='msg-comment-sender'>
                                                        <textarea  id='inputMessage' class='form-control' rows='3' placeholder='".lang("m.pmessage")."' style='width:375px; max-width: 375px; max-height:100px; margin-bottom:10px' id='textArea'></textarea> 
                                                         <button id='send-message-send' type='button' class='btn btn-primary  btn-sm width-100 apply-btn-loader' 
                                                          data-received_userid='". $this->encrypt->encode($receiver['id']) ."' 
      ...
      <!-- Delete offer modal
      ===============================================================--> 
      <div id="delete-modal" class="modal fade" tabindex="-1" data-backdrop="static"  data-keyboard="false" data-offer_id="-1"; data-received_userid="-1";  style="display: none;">
      ...
      <div id="block-user-modal-send" class="modal fade" tabindex="-1" data-backdrop="static" data-width="440px" data-keyboard="false" data-offer_id="-1"; data-received_userid="-1";  style="display: none;">
             <div class="modal-body">
                   ...
                   <textarea  id='inputMessageBlockSent' class='form-control' rows='3' style='max-width: 390px; max-height:100px; margin-bottom:10px' id='textArea'></textarea>                                                   
             </div>
             <div class="modal-footer">
                   <button type="button" data-dismiss="modal" class="btn width-100"><?= lang("g.cancel") ?></button>
      ...
      <script src="<?php echo   base_url() . 'scripts/partial/messages/contentSent.js' ?>"></script>