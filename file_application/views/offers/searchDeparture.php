                                            ...
                                            <a href='#' > <i title="<?= lang("od.map") ?>"  class='glyphicon glyphicon-eye-open icon3 one right show-map'></i> </a>
                                             <?php 
                                              if( $offer['round_trip'] == 1 && $offer['trip_type'] == 0 ){  
                                                ...
                                                // $no             = $offer['no'];
                                                // $no             = ( $no % 2 ) == 0 ? $no - 1 : $no + 1;
                                                // $id             = (  $tip == 0 ) ? $offer['ride_offer_id'] :  $offer['date_id']; 
                                                // $path           = new_url(urlCreate( $lang, $originU, $destinationU, $id , $name , $tip, $no )) ;
                                 ...
                                 <div class="panel panel-default trip-container">
                                       <div class="panel-body" style="padding:30px;">
                                               ...
                                               <div class="row row-side no-padding5" >
                                                       <div class="col-lg-9 ">
                                                                 ...
                                                                 <div class="row row-side">
                                                                      ...
                                                                      <label class="col-lg-5 no-padding text-left" style="padding-top: 9px;"> <?= $offer[$time]; ?> </label>
                                                                 </div>
                                                                 <div class="row row-side">
                                                                      <label class="col-lg-7 control-label"> <?= lang('o2.luggagesize')   ?> : </label>
                                                                      <label class="col-lg-5 no-padding text-left" style="padding-top: 9px;"> <?= $offer[$size]; ?>  </label>
                                                                 </div>
                                                                 <div class="row row-side">
                                                                      <label class='col-lg-7 control-label'> <?= lang('od.car') ?> : </label>
                                                                      <label class="col-lg-5 no-padding text-left " style="padding-top: 9px;"> 
                                                                           <span title='<?= lang("od.comfort" .  $offer['comfort'] ) ?>' class='tip rating-car star_<?=  $offer['comfort'] ?>'></span> 
                                                        ...
                                                        <div class="col-lg-3">
                                                               <?php
                                                                     if(  strcmp($offer['foto_name'], "car.png") != 0  ){
                                                                         $comfort = lang("od.comfort" .  $offer['comfort'] );
                                                                         echo "<img title='$comfort'  src='". base_url('cars/' . $offer['foto_name']) ."' width='100px' height='100px' >";
                                                                     }
                                                                     else if( $own_offer )
                                                                            echo "<div class='blank-car' ><a href='". new_url('car/upload/'.  urlencode(base64_encode( $offer['car_id'] )))  ."'>". lang("od.addcar") ."</a></div>";      
                                                                ?> 
                                                        </div>
                                                </div>
                                          </div>
                                          ...
                                          <div class="row row-side right one" >
                                              <label>
                                                    <?= lang("od.create") . date("d-m-Y", strtotime($offer['created_at']))  ." - ". lang("od.seen") . $offer['look']  . lang("od.seen2") ?>
                                                     <?php
    ...
    <script type="text/javascript">  
           var pointsSession = '<?=  $str_way?>', startSession = '<?=  $offer["originMap"]?>',endSession = '<?=  $offer["destinationMap"]?>',login = '<?=  ($this->session->userdata("logged_in") == 1) ? 1 : 0 ?>'; er.blank_date = '<?=  lang("o.blank_date")?>'; er.same_date = '<?=  lang("o.same_date")?>';   
    </script>
