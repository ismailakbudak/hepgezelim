                        ...
                        <fieldset>
                                        ...
                                        <div class="row"> 
                                            ...
                                            <div class="col-lg-4">
                                                <label for="twoWayCheck" class="hover-pointer">
                                                   <input id="twoWayCheck" type="checkbox" data-result='<?php echo ($test['round_trip'] == '1') ? 'checked' : 'unchecked'; ?>' name="twoWayCheck"> 
                                                   <?= lang('o.twoway') ?>
                                                </label>
                                            </div>
                                        </div>
                                 ...
                                 <div class="form-group form-padding">
                                   <div class="col-lg-10 col-lg-offset-9">
                                     <button id="inputUpdateOffer" type="button" class="btn btn-primary width-100 apply-btn-loader "> <span class="img-loader hide"></span>  <?= lang('ou.update') ?></button> 
                                   </div>
                                 </div>
    ...
    <script src="<?php echo  base_url() . 'scripts/partial/offer/offer-update.js'  ?>"></script>
